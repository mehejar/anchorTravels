...
const ManagePlan = () => {
    ...
    const allPlans = plans.filter((item) => {
    ...
    return (
        <div className=" w-5/6 mx-auto rounded-lg">
            <h2 className="py-16 text-4xl">Manage Products</h2>
            <div className='my-8'>
            ...
            <div className="bg-white p-8 rounded-lg">
                ...
                <div>
                    {
                        allPlans.map((product, index) => <ManageCard index={index} product={product} ></ManageCard>)
                    }
                </div>
            </div>
        </div>
